        ...
        },
        {
            ...
            render: (tag) => (
                <Space size="middle">
                    ...
                    <Button disabled={tag.id === "DEFAULT_SPACE_GROUP"} onClick={() => associatedHandle(tag)}>关联资源</Button>
                    ...
                    <Popconfirm
                        ...
                        cancelText="取消"
                    >
                        <Button disabled={tag.id === "DEFAULT_SPACE_GROUP"} type='ghost' danger>删除</Button>
                    </Popconfirm>
                </Space>
            ),
        },
