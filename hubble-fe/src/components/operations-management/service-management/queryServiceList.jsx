...
export default function QueryServiceList() {
    ...
    const [putDetailData, setPutDetailData] = useState({})//具体项的查询条件
    ...
    const [loading, setLoading] = useState(false)//搜索条件
    ...
    return (
        <div className='query_list_container graphData_wrapper'>
            ...
            <Table
                ...
                onChange={pageChange}
            />
            <CreateQuery getQuery={getQuery} detailData={putDetailData} visible={visible} setVisible={setVisible}></CreateQuery>
            <DetailModal visibleDetail={visibleDetail} setVisibleDetail={setVisibleDetail} detailData={detailData} tenant={appStore.tenant}></DetailModal>
        </div>
    )
}
