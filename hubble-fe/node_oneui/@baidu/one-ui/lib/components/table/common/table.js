...
exports["default"] = exports.getWindowHeight = void 0;
...
function (_PureComponent) {
  ...
  function ComponentTable(props) {
    ...
    _this.debouncedWindowResize = _lodash["default"].debounce(_this.handleWindowResize, 150);
  ...
  _proto.getChildContext = function getChildContext() {
    return {
      table: {
        ...
        components: _lodash["default"].merge({
          table: 'table',
          header: {
            wrapper: 'thead',
            row: 'tr',
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    if (this.props.headerFixTop !== null || this.props.bottomScroll.bottom !== null) {
      ...
      this.scrollEvent = (0, _addEventListener["default"])(window, 'scroll', this.debouncedWindowScroll);
    }
  ...
  _proto.setScrollPosition = function setScrollPosition(position) {
    ...
    if (this.tableNode) {
      ...
      if (position === 'both') {
        (0, _componentClasses["default"])(this.tableNode).remove(new RegExp("^" + prefixCls + "-scroll-position-.+$")).add(prefixCls + "-scroll-position-left").add(prefixCls + "-scroll-position-right");
      } else {
        (0, _componentClasses["default"])(this.tableNode).remove(new RegExp("^" + prefixCls + "-scroll-position-.+$")).add(prefixCls + "-scroll-position-" + position);
      }
    }
  };
  ...
  _proto.renderBottomScroll = function renderBottomScroll() {
    ...
    var bottomScroll = _react["default"].createElement("div", {
  ...
  _proto.render = function render() {
    ...
    return _react["default"].createElement(_miniStore.Provider, {
      ...
      return _react["default"].createElement("div", {
        ...
        style: props.style,
        id: props.id
      }, _this3.renderTitle(), _react["default"].createElement("div", {
...
_defineProperty(ComponentTable, "propTypes", _extends({
  headerFixTop: _propTypes["default"].number,
  bottomScroll: _propTypes["default"].object,
...
(0, _reactLifecyclesCompat.polyfill)(ComponentTable);
var _default = ComponentTable;
