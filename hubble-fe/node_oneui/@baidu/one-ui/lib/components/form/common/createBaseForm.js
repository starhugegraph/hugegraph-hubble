...
var createBaseForm = function createBaseForm(option, mixins) {
  ...
  var _option = option,
      ...
      mapProps = _option$mapProps === void 0 ? _formTools.identity : _option$mapProps,
  ...
  return function (WrappedComponent) {
    var Form = (0, _createReactClass["default"])({
      ...
      onCollectCommon: function onCollectCommon(name, action, args) {
        ...
        var value = fieldMeta.getValueFromEvent ? fieldMeta.getValueFromEvent.apply(fieldMeta, args) : _formTools.getValueFromEvent.apply(void 0, args);
        ...
        if (onValuesChange && value !== this.fieldsStore.getFieldValue(name)) {
          ...
          onValuesChange(_extends((_extends2 = {}, _extends2[formPropName] = this.getForm(), _extends2), this.props), (0, _set["default"])({}, name, value), valuesAllSet);
        }
      ...
      onCollect: function onCollect(nameCurrent, action) {
        ...
        var newField = _extends({}, field, {
          dirty: (0, _formTools.hasRules)(validate)
        });
      ...
      getFieldDecorator: function getFieldDecorator(name, fieldOption) {
        ...
        return function (fieldElem) {
          ...
          return _react["default"].cloneElement(fieldElem, _extends({
            size: size
      ...
      getFieldProps: function getFieldProps(name, usersFieldOption) {
        ...
        var validateRules = (0, _formTools.normalizeValidateRules)(validate, rules, validateTrigger);
        var validateTriggers = (0, _formTools.getValidateTriggers)(validateRules);
      ...
      getRules: function getRules(fieldMeta, action) {
        ...
        return (0, _formTools.flattenArray)(actionRules);
      },
      setFields: function setFields(maybeNestedFields, callback) {
        ...
        if (onFieldsChange) {
          ...
          var changedFields = Object.keys(fields).reduce(function (acc, name) {
            return (0, _set["default"])(acc, name, _this5.fieldsStore.getField(name));
          }, {});
      ...
      validateFieldsInternal: function validateFieldsInternal(fields, _ref, callback) {
        ...
        if (callback && (0, _formTools.isEmptyObject)(allFields)) {
          callback((0, _formTools.isEmptyObject)(alreadyErrors) ? null : alreadyErrors, this.fieldsStore.getFieldsValue(fieldNames));
          return;
        }
        ...
        validator.validate(allValues, options, function (errors) {
          ...
          if (callback) {
            ...
            callback((0, _formTools.isEmptyObject)(errorsGroup) ? null : errorsGroup, _this7.fieldsStore.getFieldsValue(fieldNames));
          }
        });
      },
      validateFields: function validateFields(ns, opt, cb) {
        ...
        var pending = new Promise(function (resolve, reject) {
          ...
          var _getParams2 = (0, _formTools.getParams)(ns, opt, cb),
          ...
          var fields = fieldNames.filter(function (name) {
            ...
            return (0, _formTools.hasRules)(fieldMeta.validate);
          }).map(function (name) {
    ...
    return (0, _formTools.argumentContainer)(Form, WrappedComponent);
  };
};
