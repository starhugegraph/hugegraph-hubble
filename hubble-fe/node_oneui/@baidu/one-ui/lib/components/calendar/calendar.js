...
var _dateInput = _interopRequireDefault(require("./common/dateInput"));

var _calendarHeader = _interopRequireDefault(require("./common/calendarHeader"));

var _calendarBody = _interopRequireDefault(require("./common/calendarBody"));

var _calendarTime = _interopRequireDefault(require("./common/calendarTime"));

var _calendarSwitch = _interopRequireDefault(require("./common/calendarSwitch"));
...
function (_Component) {
  ...
  function Calendar(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onConfirm", function () {
      ...
      var beginTimeValid = (0, _dayjs["default"])((0, _dayjs["default"])(addZero(beginTime, '/')).format('YYYY/MM/DD')).isValid();
      var endTimeValid = (0, _dayjs["default"])((0, _dayjs["default"])(addZero(_endTime, '/')).format('YYYY/MM/DD')).isValid();
      var compareBeginTimeValid = (0, _dayjs["default"])((0, _dayjs["default"])(addZero(_compareBeginTime, '/')).format('YYYY/MM/DD')).isValid();
      var compareEndTimeValid = (0, _dayjs["default"])((0, _dayjs["default"])(addZero(_compareEndTime, '/')).format('YYYY/MM/DD')).isValid();
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDateInput", function () {
      ...
      return selectMode === 'multiple' ? _react["default"].createElement("div", null, _react["default"].createElement(_dateInput["default"], inputProps), _react["default"].createElement("span", {
        className: prefixCls + "-seperate"
      }, "-"), _react["default"].createElement(_dateInput["default"], inputEndDateProps)) : _react["default"].createElement(_dateInput["default"], inputProps);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCompareDateInput", function () {
      ...
      var elm = _react["default"].createElement("div", null, _react["default"].createElement("div", {
        className: prefixCls + "-line"
      }, _react["default"].createElement(_dateInput["default"], _extends({}, inputProps, {
        date: _beginTime,
        dateType: "beginTime"
        ...
        date: _endTime,
        dateType: "endTime"
      }))), _compareSwitch ? _react["default"].createElement("div", {
        className: prefixCls + "-line-text"
      }, "\u6BD4\u8F83") : null, _compareSwitch ? _react["default"].createElement("div", {
        className: prefixCls + "-line"
      }, _react["default"].createElement(_dateInput["default"], _extends({}, inputProps, {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDateHeader", function () {
      ...
      return _react["default"].createElement(_calendarHeader["default"], calendarHeaderProps);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDateBody", function () {
      ...
      return _react["default"].createElement(_calendarBody["default"], bodyProps);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderFooter", function () {
      ...
      }, "\u53D6\u6D88"), canSelectTime && selectMode === 'single' ? _react["default"].createElement("span", {
        "data-mode": mode,
    ...
    _defineProperty(_assertThisInitialized(_this), "renderTime", function () {
      ...
      return _react["default"].createElement(_calendarTime["default"], calendarProps);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSingleDatePickerLayer", function () {
      ...
      var pickClassName = (0, _classnames["default"])(prefixCls + "-single", prefixCls + "-single-" + mode, (_classNames = {}, _classNames[prefixCls + "-single-has-comfirm"] = canSelectTime, _classNames));
      return _react["default"].createElement("div", {
        className: prefixCls + "-layer"
      }, _react["default"].createElement("div", {
        className: pickClassName
      }, mode !== 'time' ? _react["default"].createElement("div", null, _this.renderDateInput(), _this.renderDateHeader(), _this.renderDateBody()) : _this.renderTime(), _this.renderFooter()));
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCompareSwitch", function () {
      ...
      return _react["default"].createElement(_calendarSwitch["default"], switchProps);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCompareDatePickerLayer", function () {
      ...
      }, _this.renderCompareSwitch(), _react["default"].createElement("div", {
  ...
  _proto.render = function render() {
    ...
    var calendarCls = (0, _classnames["default"])(prefixCls, className, (_classNames2 = {}, _classNames2[prefixCls + "-empty"] = !buttonText, _classNames2[prefixCls + "-disabled"] = disabled, _classNames2));

    var overlay = _react["default"].createElement("span", null);
    ...
    }, _react["default"].createElement(_popLayer["default"], layerProps, _react["default"].createElement(_button["default"], {
      className: prefixCls + "-title",
      disabled: disabled,
      size: size
    }, _react["default"].createElement("span", null, text), _react["default"].createElement(_icon["default"], {
      type: "calendar"
    }))));
  };
...
_defineProperty(Calendar, "propTypes", {
  ...
  defaultBeginDate: _propTypes["default"].string,
  ...
  defaultCompareBeginDate: _propTypes["default"].string,

  /** 默认结束对比时间 selectMode 为compare时候，可选, 时间格式为YYYY/HH/mm */
  defaultCompareEndDate: _propTypes["default"].string,
  ...
  /** 对比开始时间 */
  compareBeginDate: _propTypes["default"].string,

  /** 对比结束时间 */
  compareEndDate: _propTypes["default"].string,
  ...
  canSelectTime: _propTypes["default"].bool,
  ...
  openCompareSwitch: _propTypes["default"].bool,
  ...
  onChooseDateItem: _propTypes["default"].func,

  /** time展示规则, 当 canSelectTime 为true的时候起作用，目前只支持三种展示方案，时分秒、时分、时，赋值，1-时分秒，2-时分，3-时 */
  timeRules: _propTypes["default"].number,
  ...
  rangeValidator: _propTypes["default"].func,

  /** onChooseSwitch 点击开关以后的回调 */
  onChooseSwitch: _propTypes["default"].func,
