...
function (_Component) {
  ...
  function CalendarBodyData(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "dayOnMonseEnter", function (e) {
      ...
      var dom = (0, _componentClasses["default"])(target); // 悬浮，表示要开始选第一步
      ...
      if (selectMode !== 'single') {
        if (step === 1) {
          ...
          var hoverCompareEndTime = value ? (0, _moment["default"])([fullYear, fullMonth - 1, fullDay]).add(diffDays - 1, 'days').format('YYYY/MM/DD') : '';
          ...
          if (getTimeTramp(hoverCompareEndTime) > getTimeTramp(getTodayStr()) && !canSelectFuture) {
            ...
            hoverCompareEndTime = value ? (0, _moment["default"])([fullYear, fullMonth - 1, fullDay]).add(diffDays - 1, 'days').format('YYYY/MM/DD') : '';
          }
    ...
    _defineProperty(_assertThisInitialized(_this), "dayOnMonseLeave", function (e) {
      ...
      var hoverCls = itemCls + "-active";
      var dom = (0, _componentClasses["default"])(target);
    ...
    _defineProperty(_assertThisInitialized(_this), "renderItem", function (data) {
      ...
      var singleMonthElm = _react["default"].createElement("div", {
        ...
        return _react["default"].createElement("div", {
          ...
          var daySpanCls = (0, _classnames["default"])(prefixCls + "-item", (_classNames = {}, _classNames[prefixCls + "-item-empty"] = !day, _classNames[prefixCls + "-item-selected"] = _this.isSelectedDay({
            currentDay: day
          ...
          var singleEl = _react["default"].createElement("span", {
            key: value,
            "data-value": value,
      ...
      var singleMonth = _react["default"].createElement("div", {
        key: year + "/" + month,
  ...
  _proto.render = function render() {
    ...
    }, loadingInDateMode ? _react["default"].createElement("div", {
      className: prefixCls + "-date-body-loading"
    }, "\u65E5\u671F\u6B63\u5728\u52A0\u8F7D\u4E2D...") : null, _react["default"].createElement("div", {
...
_defineProperty(CalendarBodyData, "propTypes", {
  ...
  beginTime: _propTypes["default"].string,
  onChange: _propTypes["default"].func,
  validateMinDate: _propTypes["default"].string,
  validateMaxDate: _propTypes["default"].string,
  visible: _propTypes["default"].bool,
  selectYear: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].number]),
  selectMonth: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].number]),
  ...
  compareBeginTime: _propTypes["default"].string,
  compareEndTime: _propTypes["default"].string
});
...
(0, _reactLifecyclesCompat.polyfill)(CalendarBodyData);
var _default = CalendarBodyData;
