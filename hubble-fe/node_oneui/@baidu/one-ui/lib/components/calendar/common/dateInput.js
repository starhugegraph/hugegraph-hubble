...
var strIsNumber = _core["default"].common.strIsNumber;
...
function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var inputCls = (0, _classnames["default"])(prefixCls + "-container", (_classNames = {}, _classNames[prefixCls + "-compare"] = isCompare, _classNames));
...
_defineProperty(DateInput, "propTypes", {
  ...
  /** 输完日，后进行校验 */
  onFinishInput: _propTypes["default"].func,
  ...
  /** 是否是比较日期的输入框 */
  isCompare: _propTypes["default"].bool,
