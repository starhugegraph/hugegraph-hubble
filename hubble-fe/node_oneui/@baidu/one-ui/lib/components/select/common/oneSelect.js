...
function (_PureComponent) {
  ...
  function OneSelect(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onInputKeyDown", function (event) {
      ...
      if (isMultipleOrTags(props) && !event.target.value && keyCode === _KeyCode["default"].BACKSPACE) {
        event.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_this), "getInputElement", function () {
      ...
      var inputCls = (0, _classnames5["default"])(inputElement.props.className, (_classnames = {}, _classnames[props.prefixCls + "-search__field"] = true, _classnames)); // Add space to the end of the inputValue as the width measurement tolerance
    ...
    _defineProperty(_assertThisInitialized(_this), "updateFocusClassName", function () {
      ...
      if (_this._focused) {
        (0, _componentClasses["default"])(rootRef).add(props.prefixCls + "-focused");
      } else {
        (0, _componentClasses["default"])(rootRef).remove(props.prefixCls + "-focused");
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "openIfHasChildren", function () {
      ...
      if (_react["default"].Children.count(props.children) || isSingleMode(props)) {
        _this.setOpenState(true);
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderFilterOptions", function () {
      ...
      if (tags) {
        ...
        value.forEach(function (singleValue) {
          ...
          var children = _react["default"].createElement("span", null, _react["default"].createElement(_checkbox["default"], {
            checked: true,
          ...
          var menuItem = _react["default"].createElement(_rcMenu.Item, {
        ...
        if (inputValue) {
          ...
          if (notFindInputItem) {
            options.unshift(_react["default"].createElement(_rcMenu.Item, {
              style: UNSELECTABLE_STYLE,
              role: "option",
              attribute: UNSELECTABLE_ATTRIBUTE,
              value: inputValue,
      ...
      if (!options.length && notFoundContent && !showSearch || !options.length && notFoundContent && inputValue && showSearch) {
        options = [_react["default"].createElement(_rcMenu.Item, {
          style: UNSELECTABLE_STYLE,
          attribute: UNSELECTABLE_ATTRIBUTE,
          disabled: true,
          role: "option",
      ...
      _react["default"].Children.forEach(children, function (child) {
        ...
        if (child.type.isSelectOptGroup) {
          ...
          if (innerItems.length) {
            ...
            sel.push(_react["default"].createElement(_rcMenu.ItemGroup, {
              key: key,
              title: label
            }, innerItems));
          }
        ...
        (0, _warning["default"])(child.type.isSelectOption, 'the children of `Select` should be `Select.Option` or `Select.OptGroup`, ' + ("instead of `" + (child.type.name || child.type.displayName || child.type) + "`."));
        var childValue = getValuePropValue(child);
        ...
        if (_this.filterOption(inputValue, child)) {
          ...
          if (typeof _children === 'string' && (tags || multiple)) {
            ...
            _children = _react["default"].createElement("span", null, _react["default"].createElement(_checkbox["default"], {
              checked: checked,
              prefixCls: checkboxPrefixCls
            }), _react["default"].createElement(_searchText["default"], {
              showSearch: true,
          ...
          var menuItem = _react["default"].createElement(_rcMenu.Item, _extends({
            style: UNSELECTABLE_STYLE,
            attribute: UNSELECTABLE_ATTRIBUTE,
            value: childValue,
            key: childValue,
    ...
    _defineProperty(_assertThisInitialized(_this), "renderTopControlNode", function () {
      ...
      if (isSingleMode(props)) {
        ...
        if (value.length === 1 && value[0] != null) {
          ...
          var itemClassName = (0, _classnames5["default"])(prefixCls + "-selection-selected-value", (_classnames2 = {}, _classnames2[prefixCls + "-selection-selected-value-selector-name"] = !label && selectorName, _classnames2));
      ...
      if (isMultipleOrTags(props)) {
        ...
        if (type === 'enum' || type === 'count' || type === 'custom') {
          ...
          var _selectedValue = limitedCountValueLength ? _react["default"].createElement("div", {
            key: "value",
            className: prefixCls + "-selection-selected-value",
            title: toTitle(text),
            style: {
        ...
        var inputClasses = (0, _classnames5["default"])(prefixCls + "-search", prefixCls + "-search--inline", (_classnames3 = {}, _classnames3[prefixCls + "-search-hidden"] = !open && value.length > maxTagCount, _classnames3));
        selectedValueNodes.push(_react["default"].createElement("li", {
          className: inputClasses,
          key: "input"
        }, _this.getInputElement()));
        innerNode = selectedValueNodes.length ? _react["default"].createElement("ul", {
  ...
  _proto.renderClear = function renderClear() {
    ...
    var clear = _react["default"].createElement("span", _extends({
      key: "clear",
  ...
  _proto.renderTotalDom = function renderTotalDom() {
    ...
    var totalCountCls = (0, _classnames5["default"])(prefixCls + "-selection__total_count", (_classnames4 = {}, _classnames4[prefixCls + "-selection__total_count-error"] = valueLength > maxTagCount, _classnames4[prefixCls + "-selection__total_count-min"] = ctrNodeHeight <= (heightToSizeMap[size] || heightToSizeMap.small), _classnames4));
  ...
  _proto.render = function render() {
    ...
    var sectionCls = (0, _classnames5["default"])(prefixCls + "-selection", prefixCls + "-selection--" + (multiple ? 'multiple' : 'single'));
    ...
    if (suffixIcon) {
      if (typeof suffixIcon === 'string') {
        suffixIconRender = _react["default"].createElement(_icon["default"], {
          type: suffixIcon
        });
      } else {
    ...
    var defaultTitleRender = _react["default"].createElement("div", _extends({
      ref: this.saveSelectionRef,
      key: "selection",
      className: sectionCls
    }, extraSelectionProps, {
      type: type
    }), ctrlNode, this.renderClear(), suffixIconRender ? _react["default"].createElement("span", _extends({
      key: "custom-key",
      className: prefixCls + "-custom-key",
      style: UNSELECTABLE_STYLE
    }, UNSELECTABLE_ATTRIBUTE), suffixIconRender) : _react["default"].createElement("span", _extends({
      key: "arrow",
      className: prefixCls + "-arrow",
      style: UNSELECTABLE_STYLE
    }, UNSELECTABLE_ATTRIBUTE, {
      onClick: this.onArrowClick
    }), inputIcon || _react["default"].createElement(_oneUiIcon.IconChevronDown, null)), multiple ? this.renderTotalDom() : null);
    ...
    return _react["default"].createElement(_selectTrigger["default"], {
      ...
      className: (0, _classnames5["default"])(rootCls),
...
_defineProperty(OneSelect, "propTypes", _propTypes.SelectPropTypes);
