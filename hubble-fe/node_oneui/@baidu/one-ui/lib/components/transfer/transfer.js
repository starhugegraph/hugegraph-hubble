...
exports["default"] = exports.CommonFooterRender = exports.CommonSearchRender = exports.CommonItemRender = exports.CommonTitleRender = void 0;
...
var _index = _interopRequireDefault(require("../tree/index"));
...
var _tools$transfer = _core["default"].transfer,
...
var TreeNode = _index["default"].TreeNode;
var Option = _select["default"].Option;
var Search = _input["default"].Search;

var CommonTitleRender = function CommonTitleRender(props) {
  ...
  }, titleDetail), numberDom ? _react["default"].createElement("span", {
    className: "title-number"
  }, numberDom) : null);
};

exports.CommonTitleRender = CommonTitleRender;
CommonTitleRender.propTypes = {
  title: _propTypes["default"].string.isRequired,
  treeName: _propTypes["default"].string.isRequired,
  selectedNum: _propTypes["default"].number,
  maxSelectedNum: _propTypes["default"].number,
  showSelectedNum: _propTypes["default"].bool,
  showCandidateNum: _propTypes["default"].bool,
  unSelectedNum: _propTypes["default"].number
};
...
var CommonItemRender = function CommonItemRender(props) {
  ...
  var textArray = [_react["default"].createElement("span", {
    key: "normal-0"
  }, title)];
  ...
  if (searchValue) {
    ...
    if (pivolIndex > -1) {
      textArray = _lodash["default"].flattenDeep(title.split(searchValue).map(function (node, index) {
  ...
  }, textArray, _react["default"].createElement("span", {
    className: "relation-text"
  }, ' ', relationText)) : null; // 有构造数据的 id 不存在
};

exports.CommonItemRender = CommonItemRender;
CommonItemRender.propTypes = {
  title: _propTypes["default"].string,
  relationText: _propTypes["default"].string,
...
var CommonSearchRender = function CommonSearchRender(props) {
  ...
  var searchBarClassName = (0, _classnames["default"])(prefixCls + "-search-box-bar", (_classNames = {}, _classNames[prefixCls + "-search-has-select"] = isShowLevelSelect, _classNames));
  return _react["default"].createElement("div", {
    className: searchBarClassName
  }, isShowLevelSelect ? _react["default"].createElement(_select["default"], _extends({
  ...
  })) : null, _react["default"].createElement(Search, _extends({}, searchBoxProps, customSearchProps)));
};

exports.CommonSearchRender = CommonSearchRender;
CommonSearchRender.propTypes = {
  levelOptions: _propTypes["default"].array,
  handleLevelChange: _propTypes["default"].func,
  searchBoxProps: _propTypes["default"].object,
  isShowLevelSelect: _propTypes["default"].bool,
  levelKey: _propTypes["default"].string,
  onSelectFocus: _propTypes["default"].func,
...
var CommonFooterRender = function CommonFooterRender(props) {
...
exports.CommonFooterRender = CommonFooterRender;
CommonFooterRender.propTypes = {
  treeName: _propTypes["default"].string,
  candidateFooterProps: _propTypes["default"].object,
...
function (_Component) {
  ...
  function Transfer(_args) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getSelectParentMap", function (list, selectParentMap, parentRelationMap) {
      _lodash["default"].forEach(list, function (value) {
    ...
    _defineProperty(_assertThisInitialized(_this), "allDataMapFactory", function (selectedList, allDataMap, parentRelationMap, childrenRelationMap, candidateTotalCount) {
      ...
      _lodash["default"].forEach(selectedList, function (key) {
        try {
          allDataMapWithSelected[key].isSelectorDisabled = true;
        } catch (e) {
          (0, _warning["default"])(false, "please check selectedId:" + key + " is in allDataMap");
        }
      ...
      _lodash["default"].forIn(allDataMapWithSelected, function (value, key) {
    ...
    _defineProperty(_assertThisInitialized(_this), "findLeafNode", function (id, childrenRelationMap) {
      ...
      _lodash["default"].forEach(childrenArray, function (child) {
        var leafArray = childrenRelationMap[child] || [child];
        resultArray = _lodash["default"].concat(resultArray, leafArray);
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelect", function (handleSelectParams) {
      ...
      var newExpandedKeys = _lodash["default"].concat(expandedSelectedKeys, selectedId);

      if (childrenRelationMap[selectedId]) {
        newExpandedKeys = _lodash["default"].concat(newExpandedKeys, childrenRelationMap[selectedId]);
      }
      ...
      _this.setState({
        selectedList: _lodash["default"].uniq(resultList),
        allDataMap: newAllDataMap,
        expandedSelectedKeys: _lodash["default"].uniq(newExpandedKeys)
      });
      ...
      if (shouldEmit) {
        _this.props.handleSelect(_lodash["default"].uniq(resultList), newAllDataMap, _lodash["default"].uniq(newExpandedKeys), event);
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelectAll", function (selectAllParams) {
      ...
      candidateList.forEach(function (selectedId) {
        ...
        selectedList = _lodash["default"].uniq([].concat(selectedList, result));
    ...
    _defineProperty(_assertThisInitialized(_this), "handleDelete", function (candidateParams) {
      ...
      var arr = _lodash["default"].clone(candidateArray);

      _lodash["default"].forEach(candidateArray, function (id) {
        if (childrenRelationMap[id]) {
          arr = _lodash["default"].concat(arr, childrenRelationMap[id]);
        }
      });
      ...
      _lodash["default"].remove(selectedList, function (id) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleDeleteAll", function () {
      ...
      _lodash["default"].forIn(allDataMap, function (value) {
      ...
      var newSelectedList = _lodash["default"].intersection(toBeRetainedList, selectedList);
    ...
    _defineProperty(_assertThisInitialized(_this), "makeTitle", function (item, relationText) {
      ...
      var selectorClassName = (0, _classnames["default"])({
        'select-operation': 1,
      ...
      var checkboxEle = _react["default"].createElement(_checkbox["default"], {
      ...
      var itemClassName = (0, _classnames["default"])(getContainerClass(item), (_classNames2 = {}, _classNames2[prefixCls + "-item-disabled"] = itemDisabled, _classNames2));
      return _react["default"].createElement("div", {
      ...
      }, _react["default"].createElement(CandidateItem, _extends({}, item, itemProps, candidateItemProps)), disabled ? _react["default"].createElement(_tooltip["default"], {
        title: "\u6570\u91CF\u5DF2\u8FBE\u4E0A\u9650\uFF0C\u8BF7\u5220\u9664\u540E\u6DFB\u52A0",
    ...
    _defineProperty(_assertThisInitialized(_this), "makeSelectedTitle", function (item) {
      ...
      var itemClassName = (0, _classnames["default"])(getContainerClass(item), (_classNames3 = {}, _classNames3[prefixCls + "-item-disabled"] = disabled || disabledMap[candidateId], _classNames3));
      return _react["default"].createElement("div", {
        className: itemClassName,
        onClick: _lodash["default"].partial(_this.handleDelete, candidateParams)
      }, _react["default"].createElement(SelectedItem, _extends({}, item, {
        key: "dual-tree-select-selected-" + candidateId
      }, selectedItemProps)), _react["default"].createElement(_oneUiIcon.IconClose, {
      ...
      return candidateList.map(function (key) {
        ...
        if (children) {
          ...
          return _react["default"].createElement(TreeNode, {
            ...
            selectable: false,
            disabled: disabled
          }, children.length ? _react["default"].createElement(TreeNode, null) : null);
        }
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCandidateTree", function () {
      ...
      return _react["default"].createElement(_index["default"], candidateTreeProps, _this.renderCandidateTreeNodes(candidateList, isShowLevel));
    });
    ...
    var transferData = _lodash["default"].reduce(_allDataMap, function (result, value, key) {
  ...
  _proto.render = function render() {
    ...
    if (showSelectAll && showCandidateNum) {
      ...
      _lodash["default"].forEach(candidateList, function (id) {
      ...
      candidateTreeUnSelectedCount = _lodash["default"].without.apply(_lodash["default"], [candidateLeafs].concat(selectedList)).length;
    }
    ...
    var candidateMainClass = (0, _classnames["default"])({
      'select-main': 1,
    ...
    var addOperationLinkClass = (0, _classnames["default"])({
      'operate-link': 1,
    ...
    var deleteOperationLinkClass = (0, _classnames["default"])({
      'operate-link': 1,
      'delete-disable': selectedLength <= 0,
      'display-none': !showDeleteAll
    }); // 计算已选叶子节点对应的根结点的集合

    var selectedRootKeys = _lodash["default"].uniq(selectedList.map(function (id) {
    ...
    var transferClassName = (0, _classnames["default"])("" + prefixCls, prefixCls + "-" + size, "" + className);
    return _react["default"].createElement("div", {
    ...
    }, _react["default"].createElement(CandidateTitleRender, candidateTitleProps), maxSelectedNum && candidateTreeUnSelectedCount > maxSelectedNum - selectedLength ? _react["default"].createElement(_tooltip["default"], {
      title: "\u53EF\u9009" + treeName + "\u6570\u91CF\u8D85\u8FC7\u53EF\u6DFB\u52A0\u6570\u91CF\u7684\u4E0A\u9650\uFF0C\u65E0\u6CD5\u6267\u884C\u5168\u90E8\u6DFB\u52A0",
      placement: "rightBottom",
      prefixCls: tooltipPrefixCls
    }, _react["default"].createElement("a", {
      className: addOperationLinkClass
    }, "\u5168\u9009")) : _react["default"].createElement(_button["default"], {
      type: "link",
      size: size,
      className: addOperationLinkClass,
      disabled: maxSelectedNum && candidateTreeUnSelectedCount > maxSelectedNum - selectedLength,
      onClick: _lodash["default"].partial(this.handleSelectAll, selectAllParams),
      prefixCls: buttonPrefixCls
    }, "\u5168\u9009")), showSearchBox ? _react["default"].createElement(SearchBoxRender, searchRenderProps) : null, _react["default"].createElement("div", {
      className: candidateMainClass
    }, this.renderCandidateTree(), showCandidateFooter ? _react["default"].createElement(CandidateFooterRender, _extends({
      treeName: treeName,
      ...
      className: "select-title"
    }, _react["default"].createElement(SelectedTitleRender, selectedTitleProps), _react["default"].createElement(_button["default"], {
      ...
      size: size,
      prefixCls: buttonPrefixCls
    }, "\u6E05\u7A7A")), _react["default"].createElement(_index["default"], selectedTreeProps, this.renderSelectedTreeNodes(selectedRootKeys, selectedPathMap))));
  };
...
_defineProperty(Transfer, "propTypes", {
  ...
  candidateList: _propTypes["default"].array,
   ...
   * }
   * */
  allDataMap: _propTypes["default"].object,

  /** 右侧已选树的展开节点【选填 受控】 */
  expandedSelectedKeys: _propTypes["default"].array,

  /** 子节点到父节点的映射关系，通常不用传，组件内部会计算【选填 受控】 */
  parentRelationMap: _propTypes["default"].object,

  /** 父节点到子节点的映射关系，通常不用传，组件内部会计算【选填 受控】 */
  childrenRelationMap: _propTypes["default"].object,
  ...
  handleDeleteAll: _propTypes["default"].func,

  /** 右侧已选树展开/收起时触发，回调参数(expandedSelectedKeys) 【选填】 */
  handleSelectedExpand: _propTypes["default"].func,

  /** 左侧候选树展开/收起时触发，回调参数(expandedKeys, {expanded: bool, node})【选填】 */
  handleCandidateExpand: _propTypes["default"].func,
  ...
  /** 自定义左侧树样式【选填】 */
  candidateTreeStyle: _propTypes["default"].object,

  /** 自定义右侧树样式【选填】 */
  selectedTreeStyle: _propTypes["default"].object,
  ...
  /** 自定义候选树头部标题render【选填】 */
  CandidateTitleRender: _propTypes["default"].func,

  /** 自定义已选树头部标题render【选填】 */
  SelectedTitleRender: _propTypes["default"].func,

  /** 自定义候选项格式，可实现多列选择器【选填】 */
  CandidateItem: _propTypes["default"].func,

  /** 自定义候选项的props，在传CandidateItem时生效【选填】 */
  candidateItemProps: _propTypes["default"].object,

  /** 自定义已选项格式，可实现多列选择器【选填】 */
  SelectedItem: _propTypes["default"].func,

  /** 自定义已选项的props，在传SelectedItem时生效【选填】 */
  selectedItemProps: _propTypes["default"].object,

  /** 自定义搜索筛选render【选填】 */
  SearchBoxRender: _propTypes["default"].func,

  /** 自定义搜索筛选props【选填】 */
  searchRenderProps: _propTypes["default"].object,
  ...
  isShowLevel: _propTypes["default"].bool,
  ...
  /** 是否展示新建按钮【选填】 */
  showCandidateFooter: _propTypes["default"].bool,

  /** 新建按钮自定义props【选填】 */
  candidateFooterProps: _propTypes["default"].object,

  /** 自定义footer【选填】 */
  CandidateFooterRender: _propTypes["default"].func,
  showSelectAll: _propTypes["default"].bool,
  showDeleteAll: _propTypes["default"].bool,
