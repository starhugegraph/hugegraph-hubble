...
var markType = _propTypes["default"].objectOf(_propTypes["default"].oneOfType([_propTypes["default"].shape({
...
function (_PureComponent) {
  ...
  _proto.handleWithTooltip = function handleWithTooltip(tooltipPrefixCls, _ref2) {
    ...
    }, _react["default"].createElement(_Handle["default"], _extends({}, restProps, {
      value: value,
  ...
  _proto.render = function render() {
    ...
    var className = (0, _classnames["default"])(customizePrefixCls + "-" + size, (_classNames = {}, _classNames[customizePrefixCls + "-readOnly"] = readOnly, _classNames));

    if (range) {
      return _react["default"].createElement(_Range["default"], _extends({}, restProps, {
        ref: this.saveSlider,
    ...
    return _react["default"].createElement(_Slider["default"], _extends({}, restProps, {
      ref: this.saveSlider,
      handle: function handle(info) {
        return _this3.handleWithTooltip(customizeTooltipPrefixCls, info);
      },
...
_defineProperty(Slider, "propTypes", {
  ...
  getTooltipPopupContainer: _propTypes["default"].func,
...
_defineProperty(Slider, "defaultProps", {
  ...
  onAfterChange: _lodash["default"].noop,
