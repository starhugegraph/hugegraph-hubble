...
exports.changeNumber = exports.rangeFormater = exports.numberFormater = exports.fixed = exports.rangeFilter = exports.charFilter = void 0;
 ...
 */
var charFilter = function charFilter(value) {
...
var rangeFilter = function rangeFilter(value, _ref) {
  var max = _ref.max,
      min = _ref.min,
...
var fixed = function fixed(value, _fixed) {
  value = typeof value === 'string' || typeof value === 'number' ? "" + value : '';
...
var numberFormater = function numberFormater(value, config, isRangeFormat) {
  config = config || {};
...
var rangeFormater = function rangeFormater(value, config) {
...
exports.rangeFormater = rangeFormater;

var changeNumber = function changeNumber(initialValue, stepValue, optValue) {
