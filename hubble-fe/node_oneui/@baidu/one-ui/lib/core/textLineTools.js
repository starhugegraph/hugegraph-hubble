...
exports.twoContainerBindScroll = exports.handleErrorMessageArray = exports.handleBackendError = exports.handleErrorObj = exports.getErrorMessage = exports.commonValidate = void 0;
...
// 公共校验方法
// 1. 字符超限校验
var commonValidate = function commonValidate(params) {
  return function (value) {
    var maxLen = params.maxLen,
        maxLenErrorMessage = params.maxLenErrorMessage,
        title = params.title;

    if (maxLen != null && (0, _commonTools.getRealLength)(params, value) > maxLen) {
...
exports.commonValidate = commonValidate;

var getErrorMessage = function getErrorMessage(valueArray, validateFunc, params) {
...
var handleErrorObj = function handleErrorObj(errorMessageObj) {
...
exports.handleErrorObj = handleErrorObj;

var handleBackendError = function handleBackendError(backendErrorMessageObj, value, errorMessageObj, errorIndexObj, errorArrayObj) {
  ...
  Object.keys(backendErrorMessageObj).forEach(function (errorValue) {
    ...
    var indexArray = (0, _commonTools.getAllIndexFromArray)(value, errorValue);
    ...
    if (indexArray.length) {
      ...
      errorIndexObj[errorMessage] = true;
      errorArrayObj[errorMessage] = _lodash["default"].union(errorArrayObj[errorMessage], indexArray);
    }
  });
  return {
...
exports.handleBackendError = handleBackendError;
...
var handleErrorMessageArray = function handleErrorMessageArray(_ref) {
  ...
  var realValue = (0, _commonTools.getNoEmptyArray)(value);
  ...
  if (isUnique) {
    ...
    if (_lodash["default"].uniq(realValue).length !== valueLen) {
      realValue.forEach(function (value, index) {
        var indexArray = (0, _commonTools.getAllIndexFromArray)(realValue, value);

        if (indexArray.length > 1 && uniqueIndexArray.indexOf(index) === -1) {
          uniqueIndexArray = [].concat(uniqueIndexArray, indexArray.slice(1));
        }
      });
      result[uniqueError] = _lodash["default"].union(result[uniqueError], uniqueIndexArray);
...
exports.handleErrorMessageArray = handleErrorMessageArray;

var twoContainerBindScroll = function twoContainerBindScroll(leftContainer, rightContainer) {
...
exports.twoContainerBindScroll = twoContainerBindScroll;