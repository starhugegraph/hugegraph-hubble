...
exports.dateFormat = exports.getTodayStr = exports.transObjDateFormat = exports.formatDate = exports.transDateFormat = exports.validateDateBeyondToday = exports.formatTwoDateInOrder = exports.getMaxTimeInTwoDate = exports.formatHoursByString = exports.formatDaysByScroll = exports.selectedMonthIndex = exports.initDateMonths = exports.validateData = exports.selectScrollYearIndex = exports.initFormatAllMonths = exports.formatAllMonths = exports.formatSingleYear = exports.formatSelectTime = exports.getDaysByTimeTramp = exports.getTimeTramp = exports.formatAllMonthByYear = exports.formatPerMonthInDay = exports.getTodayDetail = exports.monthDayRange = exports.isLeapYear = exports.getTimeBySwitchStr = exports.getLimitTime = exports.formatLastYearToday = exports.getDateCompareObj = exports.switchIndex = exports.formatDataText = exports.getDetailDate = exports.formatHours = exports.validateTime = exports.getTimeStamp = exports.formatTimeByRule = exports.rulesMapFormat = exports.rulesMap = exports.allMinutesAndSeconds = exports.allHours = void 0;
...
var _pickTimeTools = require("../pickTimeTools");
...
var allHours = _config.allHours;
exports.allHours = allHours;
var allMinutesAndSeconds = _config.allMinutesAndSeconds;
exports.allMinutesAndSeconds = allMinutesAndSeconds;
var rulesMap = {
  ALL: 1,
  HOUR_AND_MINUTE: 2,
  ONLY_HOUR: 3
...
var rulesMapFormat = (_rulesMapFormat = {}, _rulesMapFormat[rulesMap.ALL] = 'HH:mm:ss', _rulesMapFormat[rulesMap.HOUR_AND_MINUTE] = 'HH:mm', _rulesMapFormat[rulesMap.ONLY_HOUR] = 'HH', _rulesMapFormat);
exports.rulesMapFormat = rulesMapFormat;

var formatTimeByRule = function formatTimeByRule(time, rule) {
...
exports.formatTimeByRule = formatTimeByRule;
...
var validateTime = function validateTime(string, timeRules) {
  var format = timeRules ? rulesMapFormat[timeRules] : 'HH:mm:ss';
  var parsed = (0, _moment["default"])((0, _pickTimeTools.addZero)(string), format, true);
  return parsed.isValid();
};

exports.validateTime = validateTime;

var formatHours = function formatHours(params) {
...
var formatDataText = function formatDataText(current, compare, canSelectTime, selectMode, timeRules, compareSwitch) {
  if (!compare && !current) {
    return '';
  }
...
exports.formatDataText = formatDataText;
var switchIndex = {
  today: {
    value: 'today',
    text: '今天'
...
var getDateCompareObj = function getDateCompareObj(_ref) {
...
exports.getDateCompareObj = getDateCompareObj;

var formatLastYearToday = function formatLastYearToday() {
...
exports.formatLastYearToday = formatLastYearToday;

var getLimitTime = function getLimitTime(_ref2) {
...
exports.getLimitTime = getLimitTime;

var getTimeBySwitchStr = function getTimeBySwitchStr(_ref3) {
  ...
  switch (value) {
    case 'today':
      {
        beginTime = (0, _moment["default"])().format('YYYY/MM/DD');
        return {
          beginTime: beginTime,
          endTime: beginTime
        };
    ...
    case 'yesterday':
      {
        beginTime = (0, _moment["default"])().subtract(1, 'days').format('YYYY/MM/DD');
        return {
          beginTime: beginTime,
          endTime: beginTime
        };
    ...
    case 'lastSevenDays':
      {
        endTime = (0, _moment["default"])().subtract(1, 'days').format('YYYY/MM/DD');
        beginTime = (0, _moment["default"])().subtract(7, 'days').format('YYYY/MM/DD');
    ...
    case 'lastFourteenDays':
      {
        endTime = (0, _moment["default"])().subtract(1, 'days').format('YYYY/MM/DD');
        beginTime = (0, _moment["default"])().subtract(14, 'days').format('YYYY/MM/DD');
    ...
    case 'lastThirtyDays':
      {
        endTime = (0, _moment["default"])().subtract(1, 'days').format('YYYY/MM/DD');
        beginTime = (0, _moment["default"])().subtract(30, 'days').format('YYYY/MM/DD');
    ...
    case 'lastWeek':
      {
        beginTime = (0, _moment["default"])().week((0, _moment["default"])().week() - 1).startOf('week').format('YYYY/MM/DD');
        endTime = (0, _moment["default"])().week((0, _moment["default"])().week() - 1).endOf('week').format('YYYY/MM/DD');
    ...
    case 'lastMonth':
      {
        beginTime = (0, _moment["default"])().month((0, _moment["default"])().month() - 1).startOf('month').format('YYYY/MM/DD');
        endTime = (0, _moment["default"])().month((0, _moment["default"])().month() - 1).endOf('month').format('YYYY/MM/DD');
    ...
    case 'currentMonth':
      {
        beginTime = (0, _moment["default"])().month((0, _moment["default"])().month()).startOf('month').format('YYYY/MM/DD');
        endTime = (0, _moment["default"])().month((0, _moment["default"])().month()).endOf('month').format('YYYY/MM/DD'); // 本月为今天至今的时间
    ...
    case 'compareYesterday':
      {
        ...
        compareBeginTime = (0, _moment["default"])().subtract(1, 'days').format('YYYY/MM/DD');
        compareEndTime = (0, _moment["default"])().subtract(1, 'days').format('YYYY/MM/DD');
        return {
          beginTime: beginTime,
          endTime: endTime,
    ...
    case 'compareLastWeek':
      {
        beginTime = (0, _moment["default"])().week((0, _moment["default"])().week()).startOf('week').format('YYYY/MM/DD');
        endTime = (0, _moment["default"])().week((0, _moment["default"])().week()).endOf('week').format('YYYY/MM/DD');
        ...
        compareBeginTime = (0, _moment["default"])().week((0, _moment["default"])().week() - 1).startOf('week').format('YYYY/MM/DD');
        var diffDays = getDaysByTimeTramp(getTimeTramp(endTime) - getTimeTramp(beginTime)) - 1;
        compareEndTime = (0, _moment["default"])(compareBeginTime).add(diffDays, 'days').format('YYYY/MM/DD');
        return {
          beginTime: beginTime,
          endTime: endTime,
          compareBeginTime: compareBeginTime,
    ...
    case 'compareLastMonth':
      {
        beginTime = (0, _moment["default"])().month((0, _moment["default"])().month()).startOf('month').format('YYYY/MM/DD');
        endTime = (0, _moment["default"])().month((0, _moment["default"])().month()).endOf('month').format('YYYY/MM/DD');
        ...
        compareBeginTime = (0, _moment["default"])().month((0, _moment["default"])().month() - 1).startOf('month').format('YYYY/MM/DD');
        compareEndTime = (0, _moment["default"])(compareBeginTime).add(_diffDays, 'days').format('YYYY/MM/DD');
        return {
          beginTime: beginTime,
          endTime: endTime,
          compareBeginTime: compareBeginTime,
    ...
    case 'lastYearToday':
      {
        beginTime = (0, _moment["default"])().format('YYYY/MM/DD');
        endTime = beginTime;
        compareBeginTime = (0, _moment["default"])(lastYearToday).format('YYYY/MM/DD');
    ...
    case 'lastYearWeek':
      {
        ...
        compareBeginTime = (0, _moment["default"])(lastYearToday).week((0, _moment["default"])().week()).startOf('week').format('YYYY/MM/DD');
        compareEndTime = (0, _moment["default"])(compareBeginTime).add(_diffDays2, 'days').format('YYYY/MM/DD');
        return {
          beginTime: beginTime,
          endTime: endTime,
          compareBeginTime: compareBeginTime,
    ...
    case 'lasterYearMonth':
      {
        ...
        compareBeginTime = (0, _moment["default"])(lastYearToday).month((0, _moment["default"])().month()).startOf('month').format('YYYY/MM/DD');
        compareEndTime = (0, _moment["default"])(compareBeginTime).add(_diffDays3, 'days').format('YYYY/MM/DD');
        return {
          beginTime: beginTime,
          endTime: endTime,
          compareBeginTime: compareBeginTime,
...
exports.getTimeBySwitchStr = getTimeBySwitchStr;
...
var getTodayDetail = function getTodayDetail() {
  var todayTime = (0, _moment["default"])().format('YYYY/MM/DD');
...
var formatAllMonthByYear = function formatAllMonthByYear(totalYear) {
  var obj = {};
...
exports.formatAllMonthByYear = formatAllMonthByYear;
...
var getDaysByTimeTramp = function getDaysByTimeTramp(timeTramp) {
  return Math.ceil(timeTramp / (24 * 3600 * 1000)) + 1;
};

exports.getDaysByTimeTramp = getDaysByTimeTramp;

var formatSelectTime = function formatSelectTime(params) {
...
exports.formatSelectTime = formatSelectTime;

var formatSingleYear = function formatSingleYear(year) {
  return {
    year: year,
...
exports.formatSingleYear = formatSingleYear;

var formatAllMonths = function formatAllMonths(params) {
  var newMonthsList = [];
...
exports.formatAllMonths = formatAllMonths;

var initFormatAllMonths = function initFormatAllMonths(params) {
  var newMonthsList = [];
...
exports.initFormatAllMonths = initFormatAllMonths;

var selectScrollYearIndex = function selectScrollYearIndex(params) {
  var selectYear = params.selectYear,
      list = params.list;
  return _lodash["default"].findIndex(list, function (item) {
    return +item.year === +selectYear;
  });
};

exports.selectScrollYearIndex = selectScrollYearIndex;
...
var initDateMonths = function initDateMonths(params) {
  var list = [];
...
exports.initDateMonths = initDateMonths;

var selectedMonthIndex = function selectedMonthIndex(params) {
  var beginTime = params.beginTime,
      list = params.list;
  ...
  var index = _lodash["default"].findIndex(list, function (item) {
...
exports.selectedMonthIndex = selectedMonthIndex;

var formatDaysByScroll = function formatDaysByScroll(params) {
  var newList = [];
  var list = params.list,
...
exports.formatDaysByScroll = formatDaysByScroll;

var formatHoursByString = function formatHoursByString(string) {
...
exports.formatHoursByString = formatHoursByString;

var getMaxTimeInTwoDate = function getMaxTimeInTwoDate(_ref4) {
...
exports.getMaxTimeInTwoDate = getMaxTimeInTwoDate;

var formatTwoDateInOrder = function formatTwoDateInOrder(_ref5) {
...
exports.formatTwoDateInOrder = formatTwoDateInOrder;

var validateDateBeyondToday = function validateDateBeyondToday(date) {
...
exports.validateDateBeyondToday = validateDateBeyondToday;
...
var formatDate = function formatDate(symbol, date) {
  var seperater = '/';
  ...
  return (0, _moment["default"])(new Date(date)).format("YYYY" + seperater + "MM" + seperater + "DD");
};

exports.formatDate = formatDate;

var transObjDateFormat = function transObjDateFormat(obj) {
...
exports.transObjDateFormat = transObjDateFormat;
...
var dateFormat = function dateFormat(date, tpl) {
  ...
  _lodash["default"].forEach(Object.keys(o), function (k) {
