...
exports.isEmail = exports.isProtocolUrl = exports.isUrl = void 0;
...
var matchRegexp = function matchRegexp(value, regexp) {
...
var isProtocolUrl = function isProtocolUrl(value) {
  value = value && value.trim();
...
exports.isProtocolUrl = isProtocolUrl;
