...
var _tools$common = tools.common,
...
var normalizeColumns = tools.table.normalizeColumns;
var defaultPageSize = 20;
var defaultLocale = {
  filterTitle: '筛选',
  filterConfirm: '确定',
  filterCancel: '取消',
  emptyText: React.createElement("span", null, "\u6682\u65E0\u6570\u636E"),
  selectAll: '全选当页',
  selectInvert: '反选当页'
};
...
function (_PureComponent) {
  ...
  _proto.renderColumnsDropdown = function renderColumnsDropdown(columns) {
    ...
    return treeMap(columns, function (originColumn, i) {
      ...
      if (column.sorter || customSortNode) {
        ...
        var sortIcon = React.createElement(IconSort, null);
        var nextSortType = initialSortType;

        if (isAscend) {
          sortIcon = React.createElement(IconArrowUp, null);
          nextSortType = 'descend';
        } else if (isDescend) {
          sortIcon = React.createElement(IconArrowDown, null);
          nextSortType = 'ascend';
        } // 支持自定义排序节点， 如果没传入就用默认的


        sortButton = customSortNode || React.createElement("div", {
      ...
      var columnClassName = classNames(prefixCls + "-selection-column", column.className);
  ...
  _proto.renderRowSelection = function renderRowSelection() {
    ...
    if (rowSelection) {
      ...
      var selectionColumnClass = classNames(prefixCls + "-selection-column", (_classNames = {}, _classNames[prefixCls + "-selection-column-custom"] = rowSelection.selections, _classNames));
      var selectionColumn = {
  ...
  _proto.render = function render() {
    ...
    var locale = this.getLocale();
    var classString = classNames(prefixCls + "-" + size, (_classNames2 = {}, _classNames2[prefixCls + "-bordered"] = this.props.bordered, _classNames2[prefixCls + "-empty"] = !data.length, _classNames2[prefixCls + "-without-column-header"] = !showHeader, _classNames2));
    ...
    var table = React.createElement(TableComponent, _extends({
      key: "table"
    }, restProps, {
      prefixCls: prefixCls,
      data: data,
    ...
    return React.createElement("div", {
      className: classNames(prefixCls + "-wrapper", className, (_classNames3 = {}, _classNames3[prefixCls + "-wrapper-no-header"] = !showHeader, _classNames3)),
      style: style
