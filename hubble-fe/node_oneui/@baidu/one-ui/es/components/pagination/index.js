...
function (_PureComponent) {
    ...
    _defineProperty(_assertThisInitialized(_this), "generateItemRender", function () {
      ...
      if (lastPage < 7) {
        for (var i = 1; i <= lastPage; i++) {
          ...
          itemList.push(React.createElement(Button, itemProps, i));
        }
      ...
      for (var _i = left; _i <= right; _i++) {
        ...
        itemList.push(React.createElement(Button, _itemProps, _i));
      }

      if (pageNo - 1 >= pageBufferSize * 2 && pageNo !== 1 + pageBufferSize) {
        itemList.unshift(React.createElement("span", {
      ...
      if (left !== 1) {
        itemList.unshift(React.createElement(Button, _extends({
      ...
      if (right !== lastPage) {
        itemList.push(React.createElement(Button, _extends({
          className: prefixCls + "-pager-item",
          "data-key": lastPage,
          key: lastPage
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", paginationProps, showSizeChange && itemLength ? React.createElement("div", {
      className: prefixCls + "-select"
    }, React.createElement("span", {
      className: prefixCls + "-select-title"
    }, "\u6BCF\u9875\u663E\u793A"), React.createElement("span", {
      className: selectPrefixCls + "-container " + prefixCls + "-select-menu",
      ref: this.getPaginationContainer
    }, React.createElement(Select, paginationSelectProps, options.map(function (option) {
    ...
    }, React.createElement(IconAngleLeft, null)), itemList.map(function (item) {
      return item;
    }), React.createElement(Button, {
      className: prefixCls + "-pager-item " + prefixCls + "-pager-item-jumper",
      size: size,
    ...
    }, React.createElement(IconAngleRight, null))), showPageJumper && React.createElement("div", {
      className: prefixCls + "-jumper"
    }, React.createElement("span", {
      className: prefixCls + "-jumper-title"
    }, "\u53BB\u7B2C"), React.createElement(Input, {
      width: 40,
